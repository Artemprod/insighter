...
def crete_inline_keyboard_all_assistants(assistant_repo: MongoAssistantRepositoryORM):
    assistants_list: Assistant = assistant_repo.get_all_assistants()
...
def crete_inline_keyboard_redact_actions(assistant_repo: MongoAssistantRepositoryORM, assistant_id: str):
    assistant: Assistant = assistant_repo.get_one_assistant(assistant_id=assistant_id)
