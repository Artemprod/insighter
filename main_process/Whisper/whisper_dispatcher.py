...
async def main():
    ...
    m = MediaFileManager(file_format_manager=TelegramServerFileFormatDefiner())
    s = ShortMediaFilesTranscriber(whisper_client=a)
    l = LongMediaFilesTranscriber(whisper_client=a, media_file_manager=m)

    f = MediaRecognitionFactory(
